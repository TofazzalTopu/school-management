...
class SalDpsService {
    ...
    def saveOrUpdate(GrailsParameterMap params){
        ...
        if (params.objId) {
            ...
            salDps = new SalDps(employee: employee,
                    openInsAmount: openInsAmount,
                    totalInsAmount: openInsAmount,openOwnAmount:openOwnAmount,
                    totalOwnAmount:openOwnAmount,
    ...
    def delete(Long id) {
        ...
        salDpsRecord.updatedBy = springSecurityService.principal?.username
