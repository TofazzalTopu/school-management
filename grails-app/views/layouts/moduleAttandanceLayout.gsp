        ...
        <div id="sidebar" class="nav-collapse">
            <div class="leftside-navigation">
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <sec:access expression="hasRole('ROLE_SUPER_ADMIN') || hasRole('ROLE_ADMIN') || hasRole('ROLE_SCHOOL_HEAD') || hasRole('ROLE_HR')">
                        <li>
                    ...
                    <sec:access expression="hasRole('ROLE_SUPER_ADMIN') || hasRole('ROLE_ADMIN') || hasRole('ROLE_SCHOOL_HEAD') || hasRole('ROLE_HR')">
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li class="${params.controller == 'attnPeriod' && params.action == 'index' ? 'active' : ''}">
                                    <a href="${g.createLink(controller: 'attnPeriod',action: 'index')}">Student Attendance</a>
                                </li>
                                <li class="${params.controller == 'attnPeriod' && (params.action == 'teacher')? 'active' : ''}">
                                    <a href="${g.createLink(controller: 'attnPeriod',action: 'teacher')}">Teacher Attendance</a>
                                </li>
                            </ul>
                        </li>
                    </sec:access>
