...
<body>
<grailslab:breadCrumbActions breadCrumbTitleText="Manage Subject" SHOW_CREATE_BTN="YES" createButtonText="Add New Subject"/>
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="create-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <g:textField class="form-control" id="code" tabindex="2" name="code" placeholder="Enter Code"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Sort Order <span class="required">*</span></label>
                        <div class="col-md-6">
                            <input class="form-control" id="sortPosition" tabindex="3" name="sortPosition" placeholder="Sort order" required>
                        </div>
                    </div>
