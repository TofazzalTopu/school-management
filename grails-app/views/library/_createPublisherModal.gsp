<div class="modal fade" data-backdrop="static" data-keyboard="false" id="publisher-modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog ">
        ...
        <section class="panel">
            <div class="panel-body create-content">
                <form class="form-horizontal" role="form" id="publisher-modal-form" novalidate="novalidate">
                    <input type="hidden" name="id" id="hiddenId">

                    <div class="modal-body">

                        <div class="form-group">
                            <label class="col-md-4 control-label">Publisher Name <span class="required">*</span></label>

                            <div class="col-md-8">
                                <input type="text" name="name" id="publisherName" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Publisher Address</label>
