...
<div class="wrapsemibox">
    ...
    <h2 class="text-center"><a href="${g.createLink(controller: 'home', action: 'offlineLibrary')}">Offline Library</a> / ${libraryCategory.name}</h2>
    <g:render template="/open/gallery/offlineLibraryBookList" model="[bookList: bookList]"/>
</div>
</body>
</html>
