...
<grailslab:dataTable dataSet="${dataReturn}" tableHead="Order,Image,Name,Description,Type,Status" actions="fa fa-pencil-square-o,fa fa-retweet, fa fa-trash"></grailslab:dataTable>
<script>
    var featureType;
    jQuery(function ($) {
        $('#list-table').dataTable({
            ...
            "sAjaxSource": "${g.createLink(controller: 'sliderImage',action: 'list')}",
