...
<body>
<grailslab:breadCrumbActions firstBreadCrumbUrl="${g.createLink(controller: 'classRoutine', action: 'index')}" firstBreadCrumbText="Class Routine" breadCrumbTitleText="Add/Edit Class Routine"/>
<div class="row" >
    <div class="col-sm-12">
        <section class="panel">
