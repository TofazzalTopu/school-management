...
<head>
    ...
    <title>Student Attendance Period</title>
</head>
<body>
<grailslab:breadCrumbActions  breadCrumbTitleText="Student Attendance" SHOW_CREATE_BTN="YES"/>
        ...
        <div class="modal-content">
            <form class="form-horizontal" role="form" id="createFormModal">
                ...
                <div class="modal-body">
                    <g:hiddenField name="attnType" id="attnType" value="STUDENT"/>
                    <div class="row">
                        <div class="form-group">
                            <label for="attnTypeName" class="col-md-4 control-label">Type</label>
                            <div class="col-md-4">
                                <g:select name="attnTypeName" id="attnTypeName" from="${shift}"
    ...
    jQuery(function ($) {
        ...
        var oTable1 = $('#list-table').dataTable({
            ...
            "fnServerParams": function (aoData) {
                aoData.push({"name": "attnType", "value": "STUDENT"},{"name": "attnTypeName", "value": $("#listAttnTypeName").val()});
            },
            "aoColumns": [
                null,
                null,
        ...
        $('#list-table_wrapper div.className-filter-holder').html('<select id="listAttnTypeName" class="form-control" name="listAttnTypeName"><option value="ALL">ALL</option><g:each in="${shift}" var="type"><option value="${type.key}">${type.value}</option> </g:each></select>');
